      ...
      <div className="container" style={{ position: 'relative', zIndex: 1, maxWidth: '1200px' }}>
        ...
        <div style={{ marginBottom: '4rem' }}>
          ...
          <h2 style={{
            ...
            Why Choose <span style={{ color: '#B69359' }}>Yeppeun Skin Clinic?</span>
          </h2>
          
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.05rem', lineHeight: '1.6', maxWidth: '700px' }}>
            Yeppeun Skin Clinic offers personalised treatment plans designed around your individual needs, goals, and desired results.
          </p>
        </div>
